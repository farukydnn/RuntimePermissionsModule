...
public class PermissionsActivity extends BaseActivity {
    ...
    private final static String PrefTag = PermissionsActivity.class.toString();
    ...
    private PermissionsListener mPermissionCallback;
    ...
    /**
     * Asks for permissions and returns the result via the callback.
     *
     * @param requestedPermissions The requested permissions.
     * @param requestCode          The unique requestCode for the request.
     * @param messages             The dialog messages list. This can be null or a Map that contains a String permission name as key and a
     *                             {@link PermissionDialogMessage#PermissionDialogMessage PermissionDialogMessage} object as message that related to aforementioned permission.
     * @param responseCallback     The callback that returns the result.
     */
    ...
    private void showRequestInfoDialog(PermissionDialogMessage message) {
